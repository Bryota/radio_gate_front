...
export const Input = ({ key, value = '', text, type = 'text', is_post_code = false, is_first_item = false, validationMessages = [], searchAddressByPostCode = () => { }, change_action = () => { } }: FormInputType): JSX.Element => {
    return (
